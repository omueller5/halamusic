...
import net.owen.tutorialmod.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<T> {
	...
	public void setAngles(PorcupineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.updateAnimation(entity.idleAnimationState, ModAnimations.PORCUPINE_IDLE, ageInTicks, 3f);
		this.updateAnimation(entity.attackAnimationState, ModAnimations.PORCUPINE_ATTACK, ageInTicks, 3f);
	}
