...
public class ModFoodComponents {
    ...
    public static final FoodComponent CORN = new FoodComponent.Builder().hunger(4).saturationModifier(0.30f)
            .statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 400), 0.15f).build();
}
