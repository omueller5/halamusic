package net.owen.tutorialmod.world.biome.surface;
...
import static net.owen.tutorialmod.item.ModArmorMaterials.RUBY;
import static net.owen.tutorialmod.item.ModItems.RAW_RUBY;
